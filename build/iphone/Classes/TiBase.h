...
// in simulator we redefine to format for Gsltest Developer console
...
{\
	NSString * exceptionName = [@"org.gsltest." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.gsltest";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIGsltestNativeItemNone = -1, 
	UIGsltestNativeItemSpinner = -2,
	UIGsltestNativeItemProgressBar = -3,
	
	UIGsltestNativeItemSlider = -4,
	UIGsltestNativeItemSwitch = -5,
	UIGsltestNativeItemMultiButton = -6,
	UIGsltestNativeItemSegmented = -7,
	
	UIGsltestNativeItemTextView = -8,
	UIGsltestNativeItemTextField = -9,
	UIGsltestNativeItemSearchBar = -10,
	
	UIGsltestNativeItemPicker = -11,
	UIGsltestNativeItemDatePicker = -12,
	
	UIGsltestNativeItemInfoLight = -13,
	UIGsltestNativeItemInfoDark = -14,
	
	UIGsltestNativeItemDisclosure = -15,
	
	UIGsltestNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all Gsltest instances of
